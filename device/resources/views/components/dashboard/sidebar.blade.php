...
>
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <x-dashboard.nav-item route="dashboard.projects" label="Projects"
        ...
        <x-dashboard.nav-item route="dashboard.ai-services" label="AI Services"
        ...
        <x-dashboard.nav-item route="dashboard.code-editor" label="Code Editor"
        ...
        <x-dashboard.nav-item :href="config('vibellmpc.cloud_browser_url') . '/dashboard'" label="Cloud Dashboard" :external="true"
