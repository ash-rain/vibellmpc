<aside
    ...
    class="fixed inset-y-0 left-0 z-40 w-64 bg-gray-950 border-r border-white/[0.06] flex flex-col transition-transform duration-200 lg:translate-x-0"
>
    {{-- Logo --}}
    <div class="flex items-center gap-3 px-5 h-16 border-b border-white/[0.06]">
        ...
        <span class="font-bold text-lg text-white">VibeLLMPC</span>
    </div>
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <x-dashboard.nav-item route="dashboard.models" label="AI Models"
        ...
        <x-dashboard.nav-item route="dashboard.chat" label="Chat"
        ...
        <x-dashboard.nav-item route="dashboard.workflows" label="Workflows"
        ...
        <x-dashboard.nav-item route="dashboard.api" label="API"
        ...
        <x-dashboard.nav-item route="dashboard.tunnels" label="Tunnel"
        ...
        <div class="pt-4 mt-4 border-t border-white/[0.06]">
            <x-dashboard.nav-item route="dashboard.settings" label="System"
    ...
    <div class="px-4 py-3 border-t border-white/[0.06]">
        <div class="text-xs text-gray-500">VibeLLMPC Device</div>
    </div>
</aside>
